...
(variable) @variable
(variable_local) @variable.member
(variable_global) @variable.builtin
(variable_set) @variable.parameter
(variable_ref) @variable.parameter

(global_mode) @type
(dimensions_mode) @type
(variabili_mode) @type
...
(conditional_keyword) @function.builtin
